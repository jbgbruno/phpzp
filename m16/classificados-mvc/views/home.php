			...
			<form method="get">
				...
				<div class="form-group">
					...
					<select name="filtros[preco]" class="form-control" id="preco">
						...
						<option value="51-100" <?php echo ($filtros['preco']== '51-10') ? 'selected="selected"' : '' ?>>R$ 51 - 100</option>
						...
						<tr>
							<td>
								<?php if (!empty($anuncio['url'])) : ?>
									<img src="<?php echo BASE_URL;?>assets/images/anuncios/<?php echo $anuncio['url'] ?>" height="50">
								<?php else : ?>
									<img src="<?php echo BASE_URL;?>assets/images/default.jpg" height="50">
								<?php endif; ?>
							</td>
							<td><a href="<?php echo BASE_URL;?>produto/abrir/<?php echo $anuncio['id'] ?>"><?php echo $anuncio['titulo'] ?></a><br><?php echo $anuncio['categoria'] ?></td>
